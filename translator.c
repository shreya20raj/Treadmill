...
int main(){
	...
	while(ch1!=EOF){
		...
		f12first[j]='\0';
			...
			else if(strcmp(f8first,"01010000")==0){
				d1=bintodec(f4mid);
				d2=bintodec(f4last);				
			...
			else if(strcmp(f8first,"01010001")==0){
				d1=bintodec(f4mid);
				d2=bintodec(f4last);
				printf("status of all the registers: \n");
			...
			else if(strcmp(f12first,"010100100000")==0){
				d1=bintodec(f4last);
			...
			else if(strcmp(f12first,"010100100001")==0){
				d1=bintodec(f4last);				
			...
			else if(strcmp(f12first,"010100100010")==0){
				d1=bintodec(f4last);				
			...
			else if(strcmp(f12first,"010100100011")==0){
				d1=bintodec(f4last);				
			...
			else if(strcmp(ir,"0101001001000000")==0){
